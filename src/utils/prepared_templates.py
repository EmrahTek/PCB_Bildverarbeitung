"""Loader for template banks generated by pcb_template_tools.

This module converts generated metadata into runtime paths, canonical sizes, and
component ROIs while keeping old absolute paths portable across clones.
